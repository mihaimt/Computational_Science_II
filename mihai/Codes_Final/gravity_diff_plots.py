...
def linear_plot(x,y, data):
	...
	pyplot.colorbar(label = r"relative tangential acceleration difference")
	pyplot.title("LEVEL0 - REFINED")
#        pyplot.colorbar(label = "density [DU]")
	pyplot.clim(-.1,.1)
	pyplot.xlabel(r"$\theta$ array")
	pyplot.ylabel(r"r array")
        pyplot.show()
#	pyplot.savefig("/home/ics/mihai/Desktop/Presentations/Computational_Science_II_June/diff_rel_lvl0_ref_tangential.png")



name = "/home/ics/mihai/git/Computational_Science_II_Open/acc_t_lvl0_new.data"
r, t, d = reading_data(nr, nt, name)

name1 = "/home/ics/mihai/git/Computational_Science_II_Open/acc_t_ref.data"
