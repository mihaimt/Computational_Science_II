...
do l = 1, nt
        do j = 1, nt
                ...
                sin_diff(l,j) =   sin(theta(l)-theta(j) + dth/2) 
        enddo
enddo 
        ...
        !acceleration calculations for a single cell
                ...
                do k = 1,nr
                        do l = 1, nt
                                ...
                                den     = rad * sqrt(rad)
                                comm    = mass(k,l)*radius_corn_2_inv(i)/den                                
                                !acc calculations
                ...
                acc_r(i,j+nt/2) = acc(3)
                acc_t(i,j+nt/2) = acc(4)
...
OPEN(UNIT = 7, FILE='/home/ics/mihai/git/Computational_Science_II_Open/time_memory.data')
