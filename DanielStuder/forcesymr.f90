...
real::var2s,var3s,var4s,var5s,var6s
real::G
real::dr,dtheta
...
do j=1,dim_theta1
	do i=1,dim_r1
		...
		do l=1,dim_theta/2
			var2=cos_dtheta(j,l)
			var2s=-cos_dtheta(j,l)
			var3=sin_dtheta(j,l)
			var3s=-sin_dtheta(j,dim_theta-l)
			do k=1,dim_r/2
				!theta / r
				var4=r_sub(i,k)
				...
				!theta sym / r
				var5s=1+var4*var4-2*var4*var2s
				var5s=var5s*sqrt(var5s)*var4
				var6s=density(k,l+dim_theta/2)*dr_sub(i,k)
				var6s=var6s/var5s
				dforce_r=dforce_r+(var4-var2s)*var6s
				dforce_theta=dforce_theta+var3s*var6s
				!theta / r sym
				var4s=1/r_sub(i,k)
				var5=1+var4s*var4s-2*var4s*var2
				var5=var5*sqrt(var5)*var4s
				var6=density(k+dim_r/2,l)/r(i)*dr
				var6=var6/var5
				dforce_r=dforce_r+(var4s-var2)*var6
				dforce_theta=dforce_theta+var3*var6
				!theta sym / r sym
				var4s=1/r_sub(i,k+dim_r/2)
				var5s=1+var4s*var4s-2*var4s*var2s
				var6s=density(k,l+dim_theta/2)/r(i)*dr
				var6s=var6s/var5s
				dforce_r=dforce_r+(var4s-var2s)*var6s
				dforce_theta=dforce_theta+var3s*var6s
			end do
		end do
