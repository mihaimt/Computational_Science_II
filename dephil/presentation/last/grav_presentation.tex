...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \end{itemize}
  \item loop unrolling
  \item better programming syntax, e.g. a\textasteriskcentered a instead of a\textasteriskcentered\textasteriskcentered2 (multiplications instead of exponentials and logarithms)
